...
from disent.loss.ae import AeLoss, make_vae_recon_loss
...
class AE(BaseFramework):
    ...
    def __init__(self, make_optimizer_fn, make_model_fn, batch_augment=None, cfg: cfg = None):
        ...
        # vae recon loss
        self._recon_loss: AeLoss = make_vae_recon_loss(self.cfg.recon_loss)
    ...
    def decode(self, z: torch.Tensor) -> torch.Tensor:
        ...
        return self._recon_loss.activate(self._model.decode(z))
    ...
    def training_recon_loss(self, x_partial_recon: torch.Tensor, x_targ: torch.Tensor) -> torch.Tensor:
        return self._recon_loss.training_loss(x_partial_recon, x_targ)
