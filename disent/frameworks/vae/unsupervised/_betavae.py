...
class BetaVae(Vae):
    ...
    def __init__(
        ...
        super().__init__(make_optimizer_fn, make_model_fn, make_augment_fn=make_augment_fn)
        assert beta >= 0
        self.beta = beta
...
class BetaVaeH(BetaVae):
    ...
    def __init__(self, make_optimizer_fn, make_model_fn, make_augment_fn=None, anneal_end_steps=0, beta=4):
